# RPM spec para vigia-netscan (Vigia Suite)
# Buildado via COPR (https://copr.fedorainfracloud.org/coprs/andre28abr/vigia/)

%global pkg_name vigia-netscan
%global mod_name vigia_netscan

Name:           %{pkg_name}
Version:        0.1.0
Release:        1%{?dist}
Summary:        GUI moderna para nmap (discovery + port scan)
License:        Apache-2.0
...
%description
Wrapper GTK4 para nmap. 6 perfis pre-definidos (Discovery, Quick, Standard, Stealth, Aggressive, Full). Parse XML do nmap. Banner etico + validacao contra shell injection.

Faz parte da Vigia Suite — toolkit de seguranca para Fedora Atomic
(Silverblue, Kinoite, Bluefin, Bazzite, Aurora).

Comando: vigia-netscan
...
%files
%license LICENSE
%doc tools/network-scanner/README.md
%{_bindir}/vigia-netscan
