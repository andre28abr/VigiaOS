...
# pyproject). O diretorio-fonte e' rootkit-scanner; o modulo Python e'
# vigia_rootkit (dai o dist-info vigia_rootkit-*.dist-info, com underscore).

%global pkg_name vigia-rootkit
...
%description
Wrapper GTK4 unificado de chkrootkit e Rootkit Hunter (rkhunter). Streaming de
output em tempo real, KPI cards (testes/warnings/infectados) e historico em
...
%files
%license LICENSE
%doc tools/rootkit-scanner/README.md
%{_bindir}/vigia-rootkit
