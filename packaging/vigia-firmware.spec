# RPM spec para vigia-firmware (Vigia Suite)
# Buildado via COPR (https://copr.fedorainfracloud.org/coprs/andre28abr/vigia/)

%global pkg_name vigia-firmware
%global mod_name vigia_firmware

Name:           %{pkg_name}
Version:        0.1.0
Release:        1%{?dist}
Summary:        Analise de firmware via binwalk
License:        Apache-2.0
...
%description
Wrapper GTK4 para binwalk. Detecta signatures de arquivos embarcados em firmware, extrai componentes, calcula entropia (edges + classificacao qualitativa).

Faz parte da Vigia Suite — toolkit de seguranca para Fedora Atomic
(Silverblue, Kinoite, Bluefin, Bazzite, Aurora).

Comando: vigia-firmware

%prep
%autosetup -n VigiaOS-%{version}

%build
cd tools/firmware-analyzer
...
%files
%license LICENSE
%doc tools/firmware-analyzer/README.md
%{_bindir}/vigia-firmware
