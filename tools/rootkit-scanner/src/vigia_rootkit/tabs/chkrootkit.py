"""Tab chkrootkit — scan rapido de rootkits.

Estrutura: copy direto do pattern Antivirus scan.py. Sem KPI cards
horizontais com size_request fixo. Sem widget compartilhado. Cada
elemento dentro de Adw.PreferencesGroup que faz clamping interno.
"""
...
class ChkrootkitTab(Adw.Bin):
    """Aba chkrootkit — pattern Antivirus."""
    ...
    def __init__(self) -> None:
        ...
        # Header
        # ------------------------------------------------------------
        header_lbl = Gtk.Label(label="chkrootkit")
        ...
        # ------------------------------------------------------------
        # KPIs como Adw.PreferencesGroup
        # ------------------------------------------------------------
        ...
        # ------------------------------------------------------------
        # Output (Log) — TextView dentro de ExpanderRow > PreferencesGroup
        ...
        # ------------------------------------------------------------
        # Layout (identico ao Antivirus scan.py)
        # ------------------------------------------------------------
    ...
    def _on_scan_clicked(self, _btn) -> None:
        ...
        dlg = Adw.AlertDialog(
            heading="Iniciar scan chkrootkit?",
            body=(
