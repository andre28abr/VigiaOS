"""Vigia Tool Installer — catalogo de security tools com 1-click dnf.

v0.4.0: aba 'Pendentes' vira 'Atualizacoes' — checa (dnf check-update) e
aplica updates do sistema (painel via pkexec OU comando copiavel pro
terminal); checagem automatica ao abrir.
