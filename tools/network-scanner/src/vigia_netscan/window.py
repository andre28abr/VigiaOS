"""Janela principal — orquestra 4 tabs (Scan + Hosts + Perfis + Sobre)."""
...
from .tabs import AboutTab, HostsTab, ProfilesTab, ScanTab
...
def build_content() -> Gtk.Widget:
    ...
    stack.add_titled_with_icon(hosts_tab, "hosts", "Hosts", "network-server-symbolic")
    stack.add_titled_with_icon(profiles_tab, "profiles", "Perfis", "preferences-other-symbolic")
...
class VigiaNetscanWindow(Adw.ApplicationWindow):
    def __init__(self, app: Adw.Application):
        super().__init__(application=app)
        self.set_title("Network Scanner")
