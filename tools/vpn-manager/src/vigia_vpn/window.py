"""Janela principal — orquestra 3 tabs (Status + Perfis + Sobre)."""
...
from .tabs import AboutTab, ProfilesTab, StatusTab
...
def build_content() -> Gtk.Widget:
    ...
    stack.add_titled_with_icon(profiles_tab, "profiles", "Perfis", "view-list-symbolic")
...
class VigiaVpnWindow(Adw.ApplicationWindow):
    def __init__(self, app: Adw.Application):
        super().__init__(application=app)
        self.set_title("VPN Manager")
