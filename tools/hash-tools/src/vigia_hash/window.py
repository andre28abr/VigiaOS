"""Janela principal — orquestra 4 tabs (Hash + Verificar + Baseline + Sobre)."""
...
from .tabs import AboutTab, BaselineTab, HashTab, VerifyTab
...
def build_content() -> Gtk.Widget:
    ...
    stack = Adw.ViewStack()
    stack.add_titled_with_icon(hash_tab, "hash", "Hash", "system-run-symbolic")
    stack.add_titled_with_icon(verify_tab, "verify", "Verificar", "checkbox-checked-symbolic")
    stack.add_titled_with_icon(baseline_tab, "baseline", "Baseline", "view-list-symbolic")
...
class VigiaHashWindow(Adw.ApplicationWindow):
    def __init__(self, app: Adw.Application):
        super().__init__(application=app)
        self.set_title("Hash Tools")
