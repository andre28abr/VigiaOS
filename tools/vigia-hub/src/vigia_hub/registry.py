...
TOOLS: list[ToolEntry] = [
    ...
    ToolEntry(
        ...
        features=[
            ...
            "**Identidade do escritório** (aba *Configurações*): nome, subtítulo, logo e responsável técnico no cabeçalho/rodapé — o relatório vira documento do escritório",
            "**Agendamento automático** (timer systemd, escopo do usuário): relatório mensal gerado sozinho + modo headless `vigia-reports --generate <modelo>`",
